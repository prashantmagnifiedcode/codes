...
const Videoplayer = ({ route }) => {
    ...
    return (
        <>
            <View style={{ flex: 1, marginTop: 30 ,backgroundColor:"green"}}>
            <View style={{flex:1/2}}>
                <View
                    style={{
                        width: width,
                ...
                <View style={{ backgroundColor: colors.headercolor, height: 0.068*height, alignContent: "center", justifyContent: "center", marginBottom: 0.0068*height,backgroundColor:"yellow" }}>
                ...
                <View style={{
                    ...
                    height: 0.068*height, padding: 5, marginBottom: 2,backgroundColor:"blue"
                                    }}>


                    <View>
                        <AntDesign name="like2" size={24} color={increments == 0 ? "black" : "blue"} onPress={() => {dispatch({type:"addwatch",payload:{videoId,title,title}}) }} />
                    ...
                    <AntDesign name="sharealt" size={24} color={textcolors} />
                    <AntDesign name="download" size={24} color={textcolors} />
                    <AntDesign name="save" size={24} color={textcolors} />
                </View>
            <View style={{ height: 60 , flexDirection: "row", justifyContent: "space-around",backgroundColor:"red" }}>
            ...
            <View style={{ marginLeft: -13, marginTop: 5, flexDirection: 'row' }}>
                    ...
                    <View style={{ marginLeft: 5, marginTop: 7 }}>
                        ...
                        <Text style={{ color: textcolors, width: 110 }}>{channel}</Text></View>
                </View>
 
                <View style={{ flexDirection: "row", marginRight: 0, marginTop: 10, width: width*0.4166, justifyContent: "space-between" }}>
