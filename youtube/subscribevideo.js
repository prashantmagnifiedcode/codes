...
import { View, Text, Image, TouchableOpacity,Dimensions,Alert,Modal,Button } from 'react-native'
  ...
  return (
    <>
      ...
      >
          ...
          <View style={{ height:0.0895*height,paddingHorizontal:0, paddingTop: 5, paddingBottom: 20, flexDirection: 'row', marginTop: 1 }}>
            ...
            <View style={{ paddingHorizontal: 0,marginBottom: 4,width:0.74*width }}>
              <Text style={{ fontWeight: '600', fontSize: 14, color: "black", flex: 1, flexWrap: 'wrap' }}>
